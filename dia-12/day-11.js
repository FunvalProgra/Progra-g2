...
let algo = ["P168","Megan Anderson", "F", 1909, 1945]


// FOR IN - me devuelve el indice en cada iteracion
// 0 1 2 3 4

for(let i in algo) {
  console.log(i, algo[i]);
}

// FOR OF - me devuelve el valor en cada iteracion
// P168 | Megan Anderson | F | 1909 | 1945

// (let i = 0; i <= algo.length; i++)

for(let dato of algo) {
  console.log(dato);
}
...
// let codigo = prompt('Escribe el codigo de tu familiar:');

let code = "P206";

//primero iteramos el array personas
for(let registro of personas) {

  if(code == registro[CODIGO]) {
    let imprimir = `la persona es ${registro[NOMBRE]}, su genero es ${registro[GENERO]}. Nacio en ${registro[NACIMIENTO]} y fallecio en ${registro[DEFUNCION]}`
